...
| 020 | [Folder rename/move propagation](020-folder-rename-move-propagation.md) | 🟠 high  | [#7](https://github.com/Toilal/air-drive/issues/7) |
| 030 | [Propagate empty directories](030-propagate-empty-directories.md)   | 🟠 high     | [#1](https://github.com/Toilal/air-drive/issues/1) |
